...
These changes makes the software drift apart from its original design.
...
A refactoring tool for a dynamic language designed for unexperienced users would be an important step in filling the gap of refactoring tools for dynamic languages and it also would help the unexperienced users to have the first contact with refactoring tools and improve their code quality.
