...
Continuous changes create the a need for continuously improving the software structure.
...
Refactoring is a very desirable operation to maintain the software quality but it is a tedious and error prone activity, and because of that, it is preferable to use a tool that provides automated support. %to the refactoring operations that the programmer intends to do. 
...
They tend to create one big function that does all the program work.
...
There is two functions extracted, the print\_fibonacci and fibonacci\_seq.
