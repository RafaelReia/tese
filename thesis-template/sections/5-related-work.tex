...
Static refactoring tools have an IDE support for the refactoring operations, thus making it easier when compared to the usual refactoring tools for dynamic languages, which help managing the information. 
...
Without a refactoring tool for these languages, the users first contact with these tools is postponed and that might explain the low adoption of refactoring tools.
