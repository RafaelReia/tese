...
The following section firstly presents the use of refactoring tools and an overview of static refactoring tools.
Secondly it presents the different levels of refactorings.
Thirdly it presents the refactoring tools for the dynamic languages such as, Scheme, JavaScript, Smalltalk, Python and Racket.
%talks about multi-language refactorings
Finally it has a conclusion about the related work.

%%ADD overview + refactoring tools for static languages
...
\subsubsection{Formal Pattern Language for Refactoring of Lisp Programs}
%prof paper
...
Using metrics can support the decision where to apply refactorings and which refactorings. \cite{simon2001metrics}
