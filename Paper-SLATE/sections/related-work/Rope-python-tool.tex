...
In order to make it easier Rope makes some assumptions, it assumes that a Python program only has assignments and functions calls. %(can this be a bad thing?)
