...
The first data set that called User data set was collected\cite{murphy2006java} in 2005, it has records of 41 volunteer programmers using eclipse which 95\% of them programmed in Java. %Whit this we impplied that Refactoring tools are underused [10]
...
The Toolsmiths data set that consists in information about 4 developers who primarily maintain eclipse's refactoring tools from 12/05 to 08/07. However, it is not publicly available and not described in other papers, there is only a similar study\cite{robbes2007mining} that uses data from the author and another developer. 
...
Change signature          & Change parameter names, types and updates all references to the method.                                                                                                   \\ \hline
...
Move type to new file     & Creates a new Java compilation unit and updates all references needed.                                                                                                    \\ \hline
...
Extract interface         & Creates a new interface and makes the class implement the interface.                                                                                                      \\ \hline
Change to Supertype       & Replaces occurrences of a type with one of its supertypes after identifying all places where this replacement is possible.                                                \\ \hline
...
Generalize type           & Allows the user to choose a supertype of the reference's current type.                                                                                                    \\ \hline
